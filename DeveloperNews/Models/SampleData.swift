...
enum SampleData {
    static let items: [ContentItem] = [
        ContentItem(
            ...
            url: URL(static: "https://swiftwithmajid.com"),
        ...
        ContentItem(
            ...
            authorName: nil,
            url: URL(static: "https://news.ycombinator.com"),
        ...
        ContentItem(
            ...
            sourceCategory: .article,
            authorName: nil,
            url: URL(static: "https://developer.android.com"),
        ...
        ContentItem(
            ...
            sourceCategory: .article,
            authorName: nil,
            url: URL(static: "https://www.infoq.com"),
